...
start = ["C", 'maj', '.']  # or "<|endoftext|>" or etc. Can also specify a file, use as: "FILE:prompt.txt"
...
if type(start) != list and start.startswith('FILE:'):
    with open(start[5:], 'r', encoding='utf-8') as f:
        start = f.read().split(', ')
        start = [e.replace(' ', '') for e in start]
