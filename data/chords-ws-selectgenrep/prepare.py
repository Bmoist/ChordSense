...
'''
all the unique characters: #11, *3, ., /, 2, 3, 5, 7, 9, A, Ab, B, Bb, C, C#, Cb, D, Db, E, Eb, F, F#, Fb, G, G#, Gb, [cls], add, aug, b3, b7, b9, dim, hdim7, maj, maj7, min, min7, min9, sus4
fine-tuning dataset vocab size: 40
train has 225,001 tokens
val has 25,001 tokens
'''
